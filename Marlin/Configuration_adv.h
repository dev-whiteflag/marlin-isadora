...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define LCD_INFO_MENU
    ...
    #define LCD_PRINTER_INFO_IS_BOOTSCREEN // Show bootscreen(s) instead of Printer Info pages // FEAT(ISA)
  #endif
...
// LCD Print Progress options, multiple can be rotated depending on screen layout
  ...
  #define SCROLL_LONG_FILENAMES           // Scroll long filenames in the SD card menu // FEAT(ISA)
...
// The value of BLOCK_BUFFER_SIZE must be a power of 2 (e.g., 8, 16, 32)
  ...
  #define BLOCK_BUFFER_SIZE 32 // FEAT(ISA) DFT 16
#else
